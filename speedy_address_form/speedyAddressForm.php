<?php
   ...
   $deafultCountryName = $countriesNamesArray[$defaultCountryId];
...
<!-- jQuery UI -->
<link href='<?php echo SRC_PATH; ?>jquery-ui.min.css?v=2' rel='stylesheet' type='text/css'>
...
<div class="divAddressRow">
   <div class="divAddresdRowBox"><div class="divForeignAddressFormCountry"><span class="spanRequired">*</span> $textCountry</div><input id="speedyRcptCountryName" name="speedyRcptCountryName" class="speedyForeignAddressFormCountry" value="$deafultCountryName" autocomplete="off" role="presentation"></div>
...
<div class="divAddressRow" id="pickupOfficeRow" style="display: block;">
   <div class="divAddresdRowBoxBig"><div class="divPickupOffice"></div><input type="checkbox" id="pickupOffice" name="pickupOffice" disabled class="inputPickupOffice" onChange="pickupOfficeCheckboxActions('localoffice')"> <label for="pickupOffice">$textPickupOffice</label></div>
</div>
   
   

      
<fieldset id="fieldsetForeignRecipientSite" name="fieldsetForeignRecipientSite" class="fieldsetAddressForm" style="display: none;">
<div class="divAddressRow">
...
<div class="divAddressRow" id="foreignPickupOfficeRow" style="display: none;">
   <div class="divAddresdRowBoxBig"><div class="divPickupOffice"></div><input type="checkbox" id="foreignPickupOffice" name="foreignPickupOffice" class="inputPickupOffice" onChange="pickupOfficeCheckboxActions('foreignoffice')"> <label for="foreignPickupOffice">$textPickupOffice</label></div>
</div>
...
<fieldset id="fieldsetRoreignRecipientAddress" name="fieldsetRoreignRecipientAddress" class="fieldsetAddressForm" style="display: none;">
<div class="divAddressRow">
